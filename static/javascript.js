...
function phpTest() {
	...
	console.log('trying php test')
	message["command"] = "php_test"
	message["test_data"] = "this is some test data"
	send(message, "test.php")
}
...
function send(message, receiver="/receive") {
	// The default receiver is Flask, but we can also use php
